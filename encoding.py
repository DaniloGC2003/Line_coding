...
# retorna lista com valores dos caracteres da string de acordo com o ENCODING
def getNumericValue(msg):
    valores = []
...
# recebe string de bits, retorna lista com valores inteiros
